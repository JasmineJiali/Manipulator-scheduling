...
Pre = 60;Post = 100;
P1 = 500;P2 = 500;P3 = 660;P4 = 660;P5 = 570;P6 = 570;
...
for i = 1:lastnum
    for sub = 0:11
        ...
        elseif (sub == 1 && state{m-1,i}(1,1) ==1 && state{m-1,i}(1,2) ==0 && state{m-1,i}(1,9) == 0 && sum(state{m-1,i}(1,3:8))~=6)%Pre->BufferIn
            ...
            curnum = curnum +1;
        elseif ( sub == 2 && state{m-1,i}(1,2) == 1 && state{m-1,i}(1,3) == 0&&state{m-1,i}(1,4) == 1)%BufferIn->P1
            ...
            curnum = curnum+1;
        elseif ( sub == 2 && state{m-1,i}(1,2) == 1 && state{m-1,i}(1,3) == 1&&state{m-1,i}(1,4) == 0)%BufferIn->P2
            state{m,curnum}(1,[1 3]) = state{m-1,i}(1,[1 3]);
            state{m,curnum}(1,[2 4]) = [0 1];
            ...
            state{m,curnum}(2,1) = state{m-1,i}(2,1);
            time1 = state{m-1,i}(2,2) + rotate(2,state{m-1,i}(1,12),0) + 4;
            time2 = state{m-1,i}(2,4) + 4; 
            state{m,curnum}(2,2) = max(time1,time2);
            state{m,curnum}(2,3) = state{m-1,i}(2,3);
            state{m,curnum}(2,4) = state{m,curnum}(2,2)-4;
            state{m,curnum}(2,6) = state{m,curnum}(2,2)+P2;
            state{m,curnum}(2,[5 7:10]) = state{m-1,i}(2,[5 7:10]);
            state{m,curnum}(2,11) = state{m,curnum}(2,4)+1;
            state{m,curnum}(2,13) = i;
            
            curnum = curnum+1;
         elseif ( sub == 2 && state{m-1,i}(1,2) == 1 && state{m-1,i}(1,3) == 0 &&state{m-1,i}(1,4) == 0)
%             state{m,curnum}(1,1) = state{m-1,i}(1,1);
%             state{m,curnum}(1,2) = 0;
%             state{m,curnum}(1,3) = 1;
%             state{m,curnum}(1,4:10) = state{m-1,i}(1,4:10);
...
%             curnum = curnum+1;
            ...
            curnum = curnum+1;
        elseif (sub == 3 && state{m-1,i}(1,3) == 1 && state{m-1,i}(1,5) == 0 && state{m-1,i}(1,6) == 1) %P1 ->P3
            state{m,curnum}(1,1:2) = state{m-1,i}(1,1:2);
            state{m,curnum}(1,3) = 0;
            state{m,curnum}(1,5) = 1;
            state{m,curnum}(1,[4 6:10]) = state{m-1,i}(1,[4 6:10]);
            ...
            state{m,curnum}(2,[6 8:12]) = state{m-1,i}(2,[6 8:12]);
            state{m,curnum}(2,13) = i;
            
            curnum = curnum +1;
          elseif (sub == 3 && state{m-1,i}(1,3) == 1 && state{m-1,i}(1,5) == 1 && state{m-1,i}(1,6) == 0) %P1 ->P4
            state{m,curnum}(1,1:2) = state{m-1,i}(1,1:2);
            state{m,curnum}(1,3) = 0;
            state{m,curnum}(1,6) = 1;
            state{m,curnum}(1,[4 5 7:10]) = state{m-1,i}(1,[4 5 7:10]);
            ...
            state{m,curnum}(2,1) = state{m-1,i}(2,1);
            time1 = state{m-1,i}(2,2) + rotate(2,state{m-1,i}(1,12),1) +5;
            time2 = state{m-1,i}(2,5) + 5;
            state{m,curnum}(2,2) = max(time1,time2);
            state{m,curnum}(2,3:4) = state{m-1,i}(2,3:4);
            state{m,curnum}(2,5) = state{m,curnum}(2,2) - 5;
            state{m,curnum}(2,8) = state{m,curnum}(2,2) + P4;
            state{m,curnum}(2,[6 7 9:12]) = state{m-1,i}(2,[6 7 9:12]);
            state{m,curnum}(2,13) = i;
            
            curnum = curnum +1;
         elseif (sub == 3 && state{m-1,i}(1,3) == 1 && state{m-1,i}(1,5) == 0 && state{m-1,i}(1,6) == 0)
%              state{m,curnum}(1,1:2) = state{m-1,i}(1,1:2);
%             state{m,curnum}(1,3) = 0;
%             state{m,curnum}(1,5) = 1;
%             state{m,curnum}(1,[4 6:10]) = state{m-1,i}(1,[4 6:10]);
...
%             curnum = curnum +1;
            ...
            curnum = curnum +1;
        elseif ( sub == 4 && state{m-1,i}(1,4) == 1 && state{m-1,i}(1,5) == 0&&state{m-1,i}(1,6) == 1)%P2->P3
            state{m,curnum}(1,1:3) = state{m-1,i}(1,1:3);
            ...
            curnum = curnum+1;
          elseif ( sub == 4 && state{m-1,i}(1,4) == 1 && state{m-1,i}(1,5) == 1 &&state{m-1,i}(1,6) == 0)%P2->P4
            state{m,curnum}(1,1:3) = state{m-1,i}(1,1:3);
            state{m,curnum}(1,4) = 0;
            state{m,curnum}(1,6) = 1;
            state{m,curnum}(1,[5 7:10]) = state{m-1,i}(1,[5 7:10]);
            ...
            state{m,curnum}(2,2) = max(time1,time2);
            state{m,curnum}(2,[3 4 5 7 9 10 11 12]) = state{m-1,i}(2,[3 4 5 8 9 10 11 12]);
            state{m,curnum}(2,6) = state{m,curnum}(2,2) - 4;
            state{m,curnum}(2,8) = state{m,curnum}(2,2) + P4;
            state{m,curnum}(2,13) = i;
            
            curnum = curnum+1;
        elseif ( sub == 4 && state{m-1,i}(1,4) == 1 && state{m-1,i}(1,5) == 0 &&state{m-1,i}(1,6) == 0)
%             state{m,curnum}(1,1:3) = state{m-1,i}(1,1:3);
%             state{m,curnum}(1,4) = 0;
%             state{m,curnum}(1,5) = 1;
%             state{m,curnum}(1,6:10) = state{m-1,i}(1,6:10);
...
%             curnum = curnum+1;
            ...
            curnum = curnum+1;
        elseif (sub == 5 && state{m-1,i}(1,5) == 1 && state{m-1,i}(1,7) == 0 && state{m-1,i}(1,8) == 1)%P3 ->P5
            state{m,curnum}(1,[1:4 6 8:11 13]) = state{m-1,i}(1,[1:4 6 8:11 13]);
            state{m,curnum}(1,[5 7]) = [0 1];
           
            state{m,curnum}(1,12) = 5;
            
            state{m,curnum}(2,:) = state{m-1,i}(2,:);
            ...
            curnum = curnum+1;
        elseif (sub == 5 && state{m-1,i}(1,5) == 1 && state{m-1,i}(1,7) == 1 && state{m-1,i}(1,8) == 0)%P3 ->P6
            state{m,curnum}(1,:) = state{m-1,i}(1,:);
            state{m,curnum}(1,[5 8]) = [0 1];
           
            state{m,curnum}(1,12) = 5;
            
            state{m,curnum}(2,:) = state{m-1,i}(2,:);
            time1 = state{m-1,i}(2,2) + rotate(2,state{m-1,i}(1,12),3) + 5;
            time2 = state{m-1,i}(2,7) + 5;
            state{m,curnum}(2,2) = max(time1,time2);
            state{m,curnum}(2,7) = state{m,curnum}(2,2) - 5;
            state{m,curnum}(2,10) = state{m,curnum}(2,2) + P6;
            state{m,curnum}(2,13) = i;
            
            curnum = curnum+1;
       elseif (sub == 5 && state{m-1,i}(1,5) == 1 && state{m-1,i}(1,7) == 0 && state{m-1,i}(1,8) == 0)
%            state{m,curnum}(1,[1:4 6 8:11 13]) = state{m-1,i}(1,[1:4 6 8:11 13]);
%             state{m,curnum}(1,[5 7]) = [0 1];
%            
%             state{m,curnum}(1,12) = 5;
...
%             curnum = curnum+1;
            ...
            curnum = curnum+1;
        elseif (sub == 6 && state{m-1,i}(1,6) == 1 && state{m-1,i}(1,7) == 0&&state{m-1,i}(1,8) == 1)%P4->P5
            ...
            curnum = curnum+1;
         elseif (sub == 6 && state{m-1,i}(1,6) == 1 && state{m-1,i}(1,7) == 1 &&state{m-1,i}(1,8) == 0)%P4->P6
            state{m,curnum}(1,:) = state{m-1,i}(1,:);
            state{m,curnum}(1,[6 8]) = [0 1];
           
            state{m,curnum}(1,12) = 6;
            
            state{m,curnum}(2,:) = state{m-1,i}(2,:);
            time1 = state{m-1,i}(2,2) + rotate(2,state{m-1,i}(1,12),4) + 4;
            time2 = state{m-1,i}(2,8) + 4;
            state{m,curnum}(2,2) = max(time1,time2);
            state{m,curnum}(2,8) = state{m,curnum}(2,2) - 4;
            state{m,curnum}(2,10) = state{m,curnum}(2,2) + P6;
            state{m,curnum}(2,13) = i;
            
            curnum = curnum+1;
        elseif (sub == 6 && state{m-1,i}(1,6) == 1 && state{m-1,i}(1,7) == 0 &&state{m-1,i}(1,8) == 0)
%             state{m,curnum}(1,[1:5 8:11 13]) = state{m-1,i}(1,[1:5 8:11 13]);
%             state{m,curnum}(1,[6 7]) = [0 1];
%            
%             state{m,curnum}(1,12) = 5;
...
%             curnum = curnum+1;
        ...
        elseif (sub == 7 && state{m-1,i}(1,7) == 1 && state{m-1,i}(1,9) == 0 && state{m-1,i}(1,2) == 0)%P5->BufferOut
            state{m,curnum}(1,:) = state{m-1,i}(1,:);
            state{m,curnum}(1,[7 9]) = [0 1];
           
            state{m,curnum}(1,12) = 0;
            
            state{m,curnum}(2,:) = state{m-1,i}(2,:);
            time1 = state{m-1,i}(2,2) + rotate(2,state{m-1,i}(1,12),6) + 4;
